      ...
      <section id="home" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h1 style={{
           ...
           Empower your decisions with professional guidance from Satish Malhotra
          </h1>
          <p style={{
            fontSize: '1.3rem',
            marginBottom: '30px',
      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            ...
            gap: '60px',
            alignItems: 'center',
            gridAutoFlow: window.innerWidth > 768 ? 'row' : 'dense',
          }}>
            <div style={{ order: window.innerWidth > 768 ? 0 : 2 }}>
              <h2 style={{
                fontSize: '2.5rem',
                fontWeight: 'bold',
                marginBottom: '30px',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <h3 style={{
              ...
              Ready to Get Expert Advice from Satish Malhotra
            </h3>
            <p style={{
              marginBottom: '30px',
              opacity: 0.9,
